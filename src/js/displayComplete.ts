  ...
  if (completeList.length === 0) {
    Complete.innerHTML = `
      <div class="py-12 flex flex-col items-center justify-center text-slate-400">
          ...
          <p class="text-xs mt-1">Completed tasks show up here</p>
      </div>`;
    return;
  }
  ...
  for (let i = 0; i < completeList.length; i++) {
    ...
    <div
            ...
            >
              ...
              <div class="mt-3">
                <h3 class="text-slate-500 font-semibold tracking-wide line-through pr-16">
                  ${item.title}
                </h3>
              ...
              <div class="flex flex-wrap gap-2 mt-4">
                ${
                  item.priority === "High"
                    ? `
                    <span class="inline-flex items-center gap-1.5 bg-red-50 text-red-600 font-semibold text-[10px] uppercase px-3 py-1 rounded-full">
                ...
                ${
                  item.priority === "Medium"
                    ? `
                <span
                  class="inline-flex items-center gap-1.5 bg-amber-50 text-amber-600 font-semibold text-[10px] uppercase px-3 py-1 rounded-full"
                >
                ...
                ${
                  item.priority === "Low"
                    ? `
                <span
                  class="inline-flex items-center gap-1.5 bg-blue-50 text-blue-600 font-semibold text-[10px] uppercase px-3 py-1 rounded-full"
                >
                ...
                <span
                  class="inline-flex items-center bg-emerald-100 text-emerald-600 text-[10px] font-semibold uppercase px-2 py-1 rounded-full"
                >
              ...
              <div class="flex flex-wrap gap-2">
                <button onclick="moveToTodo(${item.id})"
                  class="flex items-center gap-1 bg-gray-100 hover:bg-gray-200 hover:scale-110 ease-in text-gray-600 font-semibold px-3 py-2 rounded-lg transition-all text-[11px]"
                >
